...
syn keyword cppSTL		priority_queue hypot stringstream isnormal isfinite isnan shared_ptr make_shared numeric_limits move array forward_as_tuple forward
